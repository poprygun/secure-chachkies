...
public class OAuth2AuthorizationServerConsentTests {
	...
	private final String redirectUri = "http://127.0.0.1/login/oauth2/code/chachkies-client-oidc";

	private final String authorizationRequestUri = UriComponentsBuilder
			.fromPath("/oauth2/authorize")
			.queryParam("response_type", "code")
			.queryParam("client_id", "chachkies-client")
			.queryParam("scope", "openid chachkies.read chachkies.write")
	...
	public void whenUserConsentsToAllScopesThenReturnAuthorizationCode() throws IOException {
		...
		assertThat(scopeIds).containsExactlyInAnyOrder("chachkies.read", "chachkies.write");
